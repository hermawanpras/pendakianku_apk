...
public class TambahUpdateAnggotaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_update_anggota);
        ...
        fotoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dipilih = 1;
                ImagePicker.Companion.with(TambahUpdateAnggotaActivity.this)
                        .compress(3000)
                        .start();
            }
        });
        ...
        simpanBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(TambahUpdateAnggotaActivity.this);
                ...
                builder.setPositiveButton("LANJUT", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        progressDialog = new ProgressDialog(TambahUpdateAnggotaActivity.this);
                ...
                builder.setNegativeButton("BATAL", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(TambahUpdateAnggotaActivity.this, "Dibatalkan", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            public void onResponse(Call<BaseResponse> call, Response<BaseResponse> response) {
                if (response != null) {
                    if (response.body().status) {
                        ...
                        Intent i = new Intent(TambahUpdateAnggotaActivity.this, UpdateAnggotaActivity.class);
                        i.putExtra("id_daftar", id);
                        startActivity(i);
                        finish();
                        Toast.makeText(TambahUpdateAnggotaActivity.this, "Anggota berhasil ditambahkan.", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(TambahUpdateAnggotaActivity.this, "Terjadi kesalahan.", Toast.LENGTH_LONG).show();
                    }
                }
            }
